...
//TODO: consumeCommand now has to take this consume function instead of a buffer reference
...
//TODO: now store only lengths of commands- untested!
const grbl = {
  len: 128,
  queued: [],
  free: 128,
  add: function (cmd) {
    ...
    this.queued.unshift(cmd.length);
  },
  use: function () {
    this.free += this.queued.pop();
  }
}
...
const consumeCommand = consumer(commands.get, sendConsole, grbl.add);
